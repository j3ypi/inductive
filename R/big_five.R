...
#'   \item{Gender}{f = female, m = male}
#'   \item{Extraversion}{Average degree of extraversion measured with 10 items (outgoing/energetic vs. solitary/reserved).}
#'   \item{Neuroticism}{Average degree of neuroticism with 10 items (sensitive/nervous vs. secure/confident).}
#'   \item{Agreeableness}{Average degree of agreeableness measured with 10 items (friendly/compassionate vs. challenging/detached).}
#'   \item{Conscientiousness}{Average degree of conscientiousness measured with 10 items (efficient/organized vs. easy-going/careless).}
#'   \item{Openness}{Average degree of opennes to experience measured with 10 items (inventive/curious vs. consistent/cautious).}
#' }
#' @source \url{https://openpsychometrics.org/_rawdata/} (modified)
"big_five"
